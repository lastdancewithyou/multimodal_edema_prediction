...
def parse_arguments():
    ...
    parser.add_argument('--cardio_weight', type=float, default=0.3, help='Cardiomegaly sub-task BCE weight')
    parser.add_argument('--pneumo_weight', type=float, default=0.0, help='Pneumonia sub-task BCE weight')
    parser.add_argument('--info_weight', type=float, default=0.02, help='Weight for Text Alignment InfoNCE loss')

    parser.add_argument('--unsupervised_weight', type=float, default=0.0, help='Unsupervised contrastive loss weight (0 to disable)')
    parser.add_argument('--contrast_temperature', type=float, default=0.2, help='Contrastive temperature')
    ...
    parser.add_argument('--img_shared_dim', type=int, default=512, help='Shared latent dim for image-segment cross-attention')
